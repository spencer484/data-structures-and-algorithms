...
const hasChildrenValues = (arr, character) => {
  let hasKids = false;
  arr.forEach(person => {
    Object.values(person)[0] === character && Object.values(person)[2].length > 0 ? hasKids = true : 0;
  });
  return hasKids;
};
...
const hasChildrenEntries = (arr, character) => {
  let hasKids = false;
  arr.forEach(person => {
    Object.entries(person)[0][1] === character && Object.entries(person)[2][1].length > 0 ? hasKids = true : hasKids;
  });
  return hasKids;
};
